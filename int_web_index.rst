...
What we'll end up is a two-page guessing game as well as a simple algorithm to play it for us, with a hi-score list displayed on the page and stored in a database. It doesn't sound like much but includes lots of software development fundamentals.
